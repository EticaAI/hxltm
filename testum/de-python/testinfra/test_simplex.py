...
#     ./testum/de-python/testinfra/test_simplex.py
#
# To test directly
#     pytest -vv ./testum/de-python/testinfra/test_simplex.py
...
def test_hxltmdexml_help(host):
    cmd = host.run("hxltmdexml --help")
