= Quickstart documentation of HXLTM - Multilingual Terminology in Humanitarian Language Exchange
:toc: left
:toclevels: 3
:icons: font
...
NOTE: `+hxltmcli+` uses Python 3 and the reference version can be installed
     with https://pypi.org/project/hxltm-eticaai/[hxltm-eticaai].
     TL;DR: `pip install hxltm-eticaai`. *The result of the lastest
     link:++#hxltmcli--help++[hxltmcli --help. is on the bottom of this page].*

NOTE: The https://github.com/EticaAI/HXL-Data-Science-file-formats/blob/main/ontologia/cor.hxltm.215.yml[HXLTM core ontology cor.hxltm.215.yml]
