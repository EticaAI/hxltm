= Multilingual Terminology in Humanitarian Language Exchange (HXLTM): end user documentation
:toc: left
:toclevels: 3
:icons: font
...
https://github.com/EticaAI/hxltm[image:https://img.shields.io/badge/GitHub-EticaAI%2Fhxltm-lightgrey?logo=github&style=social[EticaAI/hxltm]]
https://pypi.org/project/hxltm-eticaai/[image:https://img.shields.io/badge/python%20package-hxltm--eticaai-brightgreen[Python
Package: hxltm-eticaai]]
https://hxlstandard.org/[image:https://img.shields.io/badge/Standard-HXL-%23F26459[Standard
HXL]]
image:https://img.shields.io/github/license/EticaAI/hxltm[License]
...
NOTE: `+hxltmcli+` uses Python 3 and the reference version can be installed with https://pypi.org/project/hxltm-eticaai/[hxltm-eticaai].
      TL;DR: `pip install hxltm-eticaai`. *The result of the lastest link:++#hxltmcli--help++[hxltmcli --help. is on the bottom of this page].*

NOTE: The https://github.com/EticaAI/hxltm/blob/main/ontologia/cor.hxltm.215.yml[HXLTM core ontology cor.hxltm.215.yml] that comes with hxltmcli can be customized with `hxltmcli --archivum-configurationem path/to/mycopy.hxltm.yml`.
...
TIP: For advanced hackers or (people helping others in middle of urgency and
     ...
     *is possible copy only the single file
     https://github.com/EticaAI/hxltm/blob/main/bin/hxltmcli[hxltmcli.py]*,
     put on your executable path, and use immediately instead of
     hxltm-eticaai version. The hard requirements are
